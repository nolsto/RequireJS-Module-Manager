...
(function() {
  ...
  define('chaplin/application', ['backbone', 'chaplin/mediator', 'chaplin/dispatcher', 'chaplin/views/layout', 'chaplin/lib/router', 'chaplin/lib/event_broker'], function(Backbone, mediator, Dispatcher, Layout, Router, EventBroker) {
    'use strict';
